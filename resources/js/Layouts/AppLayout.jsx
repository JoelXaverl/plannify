                        ...
                        <li>
                          ...
                          <ul role="list" className="-mx-2 mt-2 space-y-1">
                            <li>
                              ...
                              >
                                <span className="text-[0.625rem flex h-6 w-6 shrink-0 items-center justify-center rounded-lg border border-foreground bg-white font-medium text-foreground">
                                  B
                                </span>
                  ...
                  <ul role="list" className="-mx-2 mt-2 space-y-2">
                    <li>
                      <Link
                        ...
                        className="group flex w-full gap-x-3 rounded-md p-3 text-sm font-semibold leading-relaxed text-foreground hover:bg-gray-100"
                      >
                        <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-lg border border-foreground bg-white text-[0.635rem] font-medium text-foreground">
                          B
                        </span>
                        <span className="truncate">Backend Developer</span>
                      </Link>
