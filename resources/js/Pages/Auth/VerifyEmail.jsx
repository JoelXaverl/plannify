                ...
                <form className="space-y-6" onSubmit={submit}>
                  ...
                  <div className="mt-4 flex items-center justify-between">
                    ...
                    <Link
                      ...
                      method="post"
                      as="button"
                      className="rounded-md text-sm text-muted-foreground underline hover:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
                    >
                      Logout
                    </Link>
                  </div>
